...
@section('main-content')
    ...
    <section class="space-y-4 px-3 md:px-6">
        <div class="rounded-2xl border border-white/10 bg-gray-800/90 p-4 shadow-sm">
        ...
        <details id="roleDistributionPanel" class="rounded-xl border border-white/10 bg-gray-800/90 p-4 shadow-sm">
            ...
            <div class="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
                <div class="min-w-0 rounded-xl border border-white/10 bg-gray-900/50 p-3">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div class="min-w-0 rounded-xl border border-white/10 bg-gray-800/90 p-4 shadow-sm lg:col-span-2">
