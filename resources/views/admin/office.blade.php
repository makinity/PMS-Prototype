    ...
    <section class="space-y-4 px-3 md:px-6">
        ...
        <div class="space-y-3 sm:hidden">
            @forelse ($offices as $office)
                ...
                @endphp
                <article class="rounded-xl border border-gray-700 bg-gradient-to-br from-gray-900 to-gray-800 p-4 shadow-sm">
            ...
            @empty
                <div class="rounded-xl border border-gray-700 bg-gradient-to-br from-gray-900 to-gray-800 px-4 py-10 text-center text-sm text-gray-400 shadow-sm">
                    No offices found.
                </div>
            @endforelse
        </div>

        <div class="hidden min-w-0 rounded-xl border border-gray-700 bg-gradient-to-br from-gray-900 to-gray-800 shadow-sm sm:block">
