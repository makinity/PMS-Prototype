...
<section class="space-y-6 admin-page">
    ...
    <!-- SUCCESS INDICATORS MODAL (READ-ONLY, DERIVED FROM UWP) -->
    <div id="uwp-indicators-modal" class="fixed inset-0 z-[90] hidden items-center justify-center bg-black/70 px-4 py-6">
        <div class="w-full max-w-2xl rounded-2xl border border-slate-800 bg-slate-900 p-5 shadow-2xl">
            ...
            <div class="mt-4 max-h-64 overflow-y-auto rounded-lg border border-slate-800 bg-slate-950/70 p-3">
                <ol id="uwp-indicators-list" class="list-decimal space-y-3 pl-5 text-sm text-slate-100"></ol>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    /**
     * ==========================================================
     *  Success Indicators Modal (Read-only) + deep link to Standards
     * ==========================================================
     */
    ...
    /**
     * ==========================================================
     *  Standards Modal (Read-only) — indicator picker + table
     * ==========================================================
     */
    ...
    /**
     * ==========================================================
     *  Wire up buttons (Indicators + Standards)
     * ==========================================================
     */
    ...
    document.querySelectorAll('[data-uwp-view-standards]').forEach((btn) => {
        btn.addEventListener('click', () => {
            let indicators = [];
            try { indicators = JSON.parse(btn.dataset.indicators || '[]'); } catch (e) { indicators = []; }
    ...
    // Escape behavior: standards first, then indicators
