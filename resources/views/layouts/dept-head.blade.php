...
<body class="min-h-screen antialiased font-sans">
    ...
    <div class="min-h-screen">
        ...
        <nav class="fixed top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/90 text-slate-100 shadow-lg shadow-slate-950/30 backdrop-blur">
            <div class="flex items-center justify-between gap-4 px-4 py-3 lg:px-6">
                <div class="flex items-center gap-3">
                    <button type="button" data-drawer-target="dept-head-sidebar" data-drawer-toggle="dept-head-sidebar" aria-controls="dept-head-sidebar" class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-slate-800 bg-slate-900/70 text-slate-200 shadow-sm transition hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-400/30 sm:hidden">
                ...
                <div class="flex items-center gap-2">
                    ...
                    @endif
                    <div class="relative">
                        <button type="button" id="dept-head-user-menu-button" data-dropdown-toggle="dept-head-user-menu" class="flex items-center gap-3 rounded-full border border-slate-800 bg-slate-900/70 px-2 py-1.5 text-left text-slate-100 shadow-sm transition hover:bg-slate-800">
                            ...
                            <span class="hidden sm:block">
                                <span class="block text-sm font-semibold text-white">Maki Dev</span>
                                <span class="block text-xs text-slate-400">Department Head</span>
                            </span>
        ...
        <!-- Sidebar -->
        <aside id="dept-head-sidebar" class="fixed left-0 top-0 z-40 h-screen w-72 -translate-x-full border-r border-slate-800/80 bg-slate-950/95 pt-16 text-slate-100 shadow-sm transition-transform sm:translate-x-0" aria-label="Sidebar">
