...
@section('main-content')
    @php
        /**
         * STAGE II — SMPOR & IPCR Accomplishment Review (Supervisor)
         * Alignment rules (STRICT):
         * - Supervisor can VIEW submitted SMPOR & IPCR accomplishment (read-only)
         * - NO approval workflow in Stage II
         * - NO rating/evaluation here (Stage III handles IPCR rating)
         * - This screen exists for visibility + traceability only
         */
        ...
        // Demo monitoring-derived totals (from submitted + rated ORS samples)
        // MPOR rule: QPts = Qty × QualityRating, TPts = Qty × TimelinessRating
        $smporSummary = [
            [
