            ...
            function renderStandardsModal(indicatorIndex) {
                ...
                if (ipcrStandardsTbody) {
                    ipcrStandardsTbody.innerHTML = ratings.map((rating) => {
                        ...
                        return `<tr class="bg-slate-900/40 align-top"><td class="px-4 py-3 font-semibold text-slate-100">${rating}</td><td class="px-4 py-3">${buildStandardsCell(Array.isArray(ratingPayload?.Q) ? ratingPayload.Q : [])}</td><td class="px-4 py-3">${buildStandardsCell(Array.isArray(ratingPayload?.E) ? ratingPayload.E : [])}</td><td class="px-4 py-3">${buildStandardsCell(Array.isArray(ratingPayload?.T) ? ratingPayload.T : [])}</td></tr>`;
                    }).join('');
                }
